...
class Full_Wave_RectifierAudioProcessorEditor  : public juce::AudioProcessorEditor
{
public:
    Full_Wave_RectifierAudioProcessorEditor (Full_Wave_RectifierAudioProcessor&);
    ~Full_Wave_RectifierAudioProcessorEditor() override;
...
private:
    ...
    Full_Wave_RectifierAudioProcessor& audioProcessor;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Full_Wave_RectifierAudioProcessorEditor)
};
