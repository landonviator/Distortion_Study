...
This plugin allows the user to select between the five distortion models and use a single drive knob for each. There is also a trim knob below the drive to make up any gain boost/attenuation. 
