...
class Half_Wave_RectificationAudioProcessorEditor  : public juce::AudioProcessorEditor
{
public:
    Half_Wave_RectificationAudioProcessorEditor (Half_Wave_RectificationAudioProcessor&);
    ~Half_Wave_RectificationAudioProcessorEditor() override;
...
private:
    ...
    Half_Wave_RectificationAudioProcessor& audioProcessor;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Half_Wave_RectificationAudioProcessorEditor)
};
