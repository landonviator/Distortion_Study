...
class ViatorHardClipperAudioProcessorEditor  : public juce::AudioProcessorEditor, juce::Slider::Listener
{
public:
    ViatorHardClipperAudioProcessorEditor (ViatorHardClipperAudioProcessor&);
    ~ViatorHardClipperAudioProcessorEditor() override;
...
private:
    ...
    ViatorHardClipperAudioProcessor& audioProcessor;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ViatorHardClipperAudioProcessorEditor)
};
